  ...
  *is_subkey = 0;
  ...
  for (p = buf; p; p = pend)
  {
    ...
    switch (field)
    {
      ...
      case 4:                   /* pubkey algo */
      {
        dprintf(2, "pubkey algorithm: %s", p);
      ...
      case 12:                  /* key capabilities */
        dprintf(2, "capabilities info: %s", p);
